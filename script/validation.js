...
const doubleCheckEmailAddress = function() {
	if (isValidEmailAddress(email.input.value)) {
		...
		if (isEmpty(email.input.value)) {
			email.errorMessage.innerText = 'Dit is een verplicht veld';
		} else {
			email.errorMessage.innerText = 'Niet geldig e-mail adres';
		}
	}
};
...
const getDOMElements = function() {
	...
	signInButton = document.querySelector('.js-button');
